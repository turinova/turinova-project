<?php
/**
 * Cancellation Reasons Entry Point
 */
...
requirePageAccess('cancellation_reasons');
...
if (isset($_GET['action'])) {
    ...
    if ($action === 'add' && $_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        require_once '../app/controllers/CancellationReasonsController.php';
        $controller = new CancellationReasonsController();
        $controller->add();
        exit;
    }
