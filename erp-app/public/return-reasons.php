...
requirePageAccess('return_reasons');
...
if (isset($_GET['action'])) {
    ...
    if ($action === 'add' && $_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        require_once '../app/controllers/ReturnReasonsController.php';
        $controller = new ReturnReasonsController();
        $controller->add();
        exit;
    }
