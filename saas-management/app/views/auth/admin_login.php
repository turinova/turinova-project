...
<html
  ...
  <head>
    ...
    <title>SaaS Admin Login - SaaS Management</title>
        ...
        <div class="authentication-inner py-6">
          ...
          <div class="card p-md-7 p-1">
            ...
            <div class="app-brand justify-content-center mt-5">
              <a href="<?= SAAS_BASE_URL ?>/admin_login.php" class="app-brand-link gap-2">
            ...
            <div class="card-body mt-1">
              <h4 class="mb-1">SaaS Admin Login 👋</h4>
              <p class="mb-5">Manage your multi-tenant ERP system</p>

              <?php if (!empty($error)): ?>
                <div class="alert alert-danger mb-4"><?= htmlspecialchars($error) ?></div>
              <?php endif; ?>

              <form method="POST" action="<?= SAAS_BASE_URL ?>/admin_login.php" class="mb-5">
