...
<html
  ...
  <head>
    ...
    <title>Regisztráció - <?= SAAS_APP_NAME ?></title>
        ...
        <div class="authentication-inner py-6">
          ...
          <div class="card p-md-7 p-1">
            ...
            <div class="app-brand justify-content-center mt-5">
              <a href="<?= SAAS_BASE_URL ?>/register.php" class="app-brand-link gap-2">
            ...
            <div class="card-body mt-1">
              <h4 class="mb-1">Új fiók létrehozása! 🚀</h4>
              <p class="mb-5">Regisztráljon új vállalat fiókot</p>
              ...
              <form method="POST" action="<?= SAAS_BASE_URL ?>/register.php" class="mb-5">
                <div class="form-floating form-floating-outline mb-5 form-control-validation">
                  ...
                  <small class="form-text text-muted">Csak betűk, számok és kötőjelek (pl: company1)</small>
                </div>
                ...
                <div class="form-floating form-floating-outline mb-5 form-control-validation">
                  ...
                  <label for="company_name">Cég neve</label>
                </div>
                ...
                <div class="mb-5">
                  ...
                  <small class="form-text text-muted">Legalább 6 karakter</small>
                </div>
                
                <div class="mb-5">
                  <button class="btn btn-primary d-grid w-100" type="submit">Fiók létrehozása</button>
                </div>
              </form>
              ...
              <div class="text-center">
                <p class="mb-0">
                  Már van fiókja? 
                  <a href="<?= SAAS_BASE_URL ?>/login.php">
          ...
          <img
            alt="mask"
            src="<?= ASSETS_PATH ?>/assets/img/illustrations/auth-basic-register-mask-light.png"
